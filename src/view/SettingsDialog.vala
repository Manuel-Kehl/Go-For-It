...
public class SettingsDialog : Gtk.Dialog {
    ...
    private void setup_advanced_settings_widgets () {
        /* Instantiation */
        task_lbl = new Gtk.Label ("Task duration (minutes)" + ":");
        break_lbl = new Gtk.Label ("Break duration (minutes)" + ":");
        reminder_lbl = new Gtk.Label ("Reminder before task ends (seconds)" +":");
