...
class GOFI.NotificationsPage : Gtk.Grid {
    ...
    private void setup_notification_settings_widgets (ref int row) {
        ...
        break_start_sound_cbox.append ("custom", _("Custom"));
        break_end_sound_cbox.append ("custom", _("Custom"));
        break_start_sound_cbox.append ("silent", _("Silent"));
        break_end_sound_cbox.append ("silent", _("Silent"));
